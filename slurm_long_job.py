...
if __name__ == "__main__":
    ...
    command = f"sbatch --export=ALL,SAVE_DIR={save_dir},LONG_JOB=TRUE --job-name {exp_name} --output {save_dir}/slurm-log.txt aff_train.sh {' '.join(unknown_args)}  --long_training --save_path {save_path} --exp_name {exp_name}"
